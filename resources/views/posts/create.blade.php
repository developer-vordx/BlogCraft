    ...
    <div class="flex-1 p-8">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl shadow-sm p-8">
                ...
                <form id="create-post-form" class="space-y-6" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="title" class="block text-sm font-medium text-gray-700 mb-2">Post Title</label>
                        <input type="text" value="{{ old('title') }}" id="title" name="title" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-colors" placeholder="Enter your post title..." required>
                        ...
                        <div id="image-upload-area" class="relative border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-orange-400 transition-colors cursor-pointer">
                            ...
                            <div id="image-preview" class="hidden">
                                <div class="relative inline-block">
                                    <img id="preview-image" src="" alt="Feature image preview" class="max-w-full max-h-64 rounded-lg shadow-md">
                                ...
                                <p id="image-name" class="text-sm text-gray-600 mt-3 font-medium"></p>
                                <p id="image-size" class="text-xs text-gray-400"></p>
                            </div>
                            ...
                            <input type="file" id="feature_image" name="featured_image" accept="image/*" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer">
                        </div>
                    </div>
